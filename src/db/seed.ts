...
async function seed() {
  ...
  const inserted = await db
    .insert(customers)
    .values([
      { firstName: "Olivia", lastName: "Bennett", name: "Olivia Bennett", phone: "0412 345 678", email: "olivia@example.com", defaultLengthMin: 45, birthday: "2000-07-14", usualGap: "4 weeks" },
      { firstName: "Liam", lastName: "Carter", name: "Liam Carter", phone: "0423 111 222", email: "liam@example.com", defaultLengthMin: 30, birthday: "2000-03-02", usualGap: "3 weeks" },
      { firstName: "Sophie", lastName: "Nguyen", name: "Sophie Nguyen", phone: "0455 987 654", email: "sophie@example.com", defaultLengthMin: 60, birthday: "2000-11-23", usualGap: "6 weeks" },
      { firstName: "Marcus", lastName: "Reed", name: "Marcus Reed", phone: "0466 222 333", email: "marcus@example.com", defaultLengthMin: 20, birthday: "2000-06-02", usualGap: "2 weeks" },
      { firstName: "Ava", lastName: "Thompson", name: "Ava Thompson", phone: "0477 444 555", email: "ava@example.com", defaultLengthMin: 90, birthday: "2000-01-30", usualGap: "3 months" },
      { firstName: "Noah", lastName: "Williams", name: "Noah Williams", phone: "0488 555 666", email: "noah@example.com", defaultLengthMin: 40, birthday: "2000-09-09", usualGap: "5 weeks" },
    ])
    .returning();
